...
2. **Аугментация и временные признаки**: улучшает распознавание в условиях сложного фона (ConvLSTM, 3D-CNN).
    - Разнообразные методы аугментации, такие как изменение яркости, контраста, добавление шума, повороты и увеличение, помогут модели распознавать зайцев в изменяющихся условиях. Это снизит FN за счет лучшего распознавания зайцев, например, в тени или в условиях плотной растительности.
    - Использование 3D-CNN или ConvLSTM слоев добавит временную компоненту, позволяя учитывать движения зайцев между кадрами. Это помогает избежать FP, так как модель научится различать случайные движения фона (ветви, трава) от движений зайцев.
