...
Чтобы разобраться с задачей детекции животных на видеоданных и для понимания существующих подходов и методов в этой области, я провел обзор публикаций, готовых проектов и доступных датасетов. Я не являюсь специалистом в компьютерном зрении, поэтому постарался изучить уже существующие решения.  
Ссылки (материалы) разделены на три категории — публикации (исследования), готовые проекты и датасеты. Естественно, это всего лишь беглый осмотр темы и "низко висящие яблоки".
